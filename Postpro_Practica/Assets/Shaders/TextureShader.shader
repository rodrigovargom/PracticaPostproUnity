Shader "Custom/TextureShader"
{
    ...
    SubShader
    {
        ...
        sampler2D _mainTexture, _emissionTexture, _normalTexture;
        half _smoothness, _metallic, _emissionIntensity, _normalIntensity;
        ...
        void surf (Input IN, inout SurfaceOutputStandard o)
        {
            ...
            o.Emission = tex2D(_emissionTexture, IN.uv_emissionTexture).rgb *
                _emissionIntensity * _emissionColor.rgb;
